...
A web app for [`varchar`](../README.md): run SQL against a database that is one
...
web/
  ...
  src/
    ...
    components/      Ask, Answer (with the read head aside), Tape, Printout, LogPane, Topbar, dialogs, ui
    lib/             db (wasm boot + statement splitting), bytes, tape, pattern, sql, presets, reference, csv
    styles/          app.css — thin app layer over the catppuccin-neu package
